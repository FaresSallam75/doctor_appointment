...
startOnInital(context, String type, [String? doctorId]) async {
  ...
  FirebaseMessaging.onMessage.listen((RemoteMessage message) {
    if (message.notification != null) {
      if (message.data['type'] == "chat") {
        ...
        BlocProvider.of<ChatCubit>(context).viewAllMessages(doctorId!);
        //"/chatPage"
        ...
        BlocProvider.of<AppointmentCubit>(context).refreshAppointments();
        notificationService.showNotification(
          id: 0,
          title: message.notification!.title!,
          body: message.notification!.body!,
...
void myRequestPermission() async {
